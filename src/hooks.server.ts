...
import { getAdminStatus } from '$lib/config/admin';
...
const authHandler: Handle = async ({ event, resolve }) => {
	// Secure session handling with JWT validation
...
export const handle: Handle = sequence(supabase, authHandler, handleParaglide);
